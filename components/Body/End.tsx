        ...
        >
            ...
            >
                <svg 
                    ...
                    className="w-full h-[50px] fill-zinc-100 block overflow-visible"
                >
                    <use href="#fixed-convex"/> 
                </svg>
            </div>
            <section
                className="px-16 py-36 items-center justify-center z-50 bg-zinc-100"
            > 
                ...
                <div className="flex flex-col items-center group">
                    <HackerText
                        ...
                        speed={50}
                        className={`font-black text-6xl tracking-tighter text-center font-mono`}
                    />
